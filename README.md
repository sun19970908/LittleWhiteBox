...
16. l2下边不保留l0（L0与L2语义重复），需要循环任务
17. 已总结证据预算硬上限从5000放开到50000，需要循环任务（UI里不能改）
18. direct数量三闸门做成变量（楼层精排幸存数/融合候选数/事件选择上限），并入预算循环任务，大聊天可自行扩容direct证据
