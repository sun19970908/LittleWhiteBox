// Compatibility: exact default shipped before persistent Fourth Wall memory.
// Customized templates are never rewritten. Retire with support for pre-memory settings.
export const PRE_MEMORY_META_PROTOCOL = `
阅读以上内容后，看本次任务具体要求:
<meta_protocol>
# 输出规范：
## 你的身份设定认知：【语C搭档】
