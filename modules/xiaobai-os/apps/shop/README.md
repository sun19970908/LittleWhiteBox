...
`apps/shop`负责 Shop/Economy 原子购买、道具操作、效果交付、客户端 DTO、主 RP Prompt 注入和 Vue UI。账户归属、存储及事务边界见 [Economy 平台终态设计](../../docs/economy-platform-target-design.md)。
...
- `host/controller.ts`：app activation、存储准备、操作状态和 iframe 协议。
