...
var he = { class: "shop-dialog-heading" }, me = { class: "shop-dialog-item" }, fe = { key: 0 }, pe = { key: 1 }, Te = {
  ...
  setup(t, { emit: T }) {
    const r = t, h = T, o = f1({}), v = y(() => r.mode === "purchase" ? "确认购买" : r.mode === "use" ? "使用奇物" : "关闭效果？"), u = y(() => r.mode !== "use" || r.item.inputs.every((b) => String(o[b.key] || "").trim().length > 0)), c = y(() => !r.busy && !r.disabledReason && u.value);
    function l() {
      c.value && h("confirm", { ...o });
    }
    return (b, q) => (a(), Q(M1, {
      ...
      default: b1(() => [e("form", { onSubmit: g1(l, ["prevent"]) }, [
