...
var he = { class: "shop-dialog-heading" }, me = { class: "shop-dialog-item" }, fe = { key: 0 }, pe = { key: 1 }, Te = {
  ...
  setup(t, { emit: T }) {
    ...
    return (b, q) => (a(), Q(M1, {
      ...
      default: y1(() => [e("form", { onSubmit: g1(l, ["prevent"]) }, [
...
}, bt = ["data-category"], yt = { class: "shop-detail-category" }, kt = { class: "shop-detail-copy" }, gt = { id: "shop-detail-title" }, Zt = { class: "shop-detail-price" }, $t = { class: "shop-detail-description" }, Mt = { class: "shop-item-terms" }, wt = { key: 0 }, xt = { class: "shop-use-guide" }, _t = { key: 0 }, Lt = {
  key: 0,
  ...
  "aria-label": "商店主导航"
}, Ft = ["aria-current"], Jt = ["aria-current"], Kt = { key: 0 }, Yt = ["aria-current"], Wt = { key: 0 }, Y = 35e3, Xt = /* @__PURE__ */ I({
  __name: "ShopApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(t) {
    const T = t, r = x(structuredClone(b1(T.initialState))), h = x("shelf"), o = x(null), v = x(null), u = y(() => r.value.catalog.find((d) => d.id === v.value)), c = y(() => r.value.catalog.reduce((d, s) => d + s.quantity, 0)), l = y(() => r.value.activations.filter((d) => d.state === "active").length), b = x("");
    let q = 0;
    ...
    return f1(() => {
      ...
      r.value.message || _.value || b.value ? (a(), i("div", Et, [r.value.message || _.value ? (a(), i("aside", {
        key: 0,
        class: W(["shop-notice", { "is-error": _.value || r.value.status === "blocked" || r.value.status === "conflict" }]),
        role: "status"
      ...
      e("nav", Ot, [
        ...
        }, [e("span", null, [f(k, { name: "spark" }), l.value ? (a(), i("i", Wt, n(l.value), 1)) : p("", !0)]), s[13] || (s[13] = Z("生效中", -1))], 8, Yt)
      ]),
