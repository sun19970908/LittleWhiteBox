/* eslint-disable */
import { C as se, E as re, H as K, J as be, K as L, L as ge, S as Y, Y as s, b as ae, c as Z, gt as u, h as F, j as T, k as a, l as b, m as V, mt as _, o as O, p as U, q as me, r as M, s as t, u as n, z as B } from "./xiaobai-os-runtime-core.esm-bundler-x_Eikhco.js";
import { a as ee, c as G, l as z, o as Q, s as ne } from "./xiaobai-os-runtime-dom.esm-bundler-DWFjb9Vy.js";
import { n as X, r as oe } from "./xiaobai-os-app-navigation-BcQEoInO.js";
var ye = ["disabled"], ke = {
  key: 0,
  ...
  setup(e, { emit: l }) {
    ...
    return (c, k) => (a(), n("form", {
      ...
      e.response.kind === "choice" ? (a(), n("div", ke, [(a(!0), n(M, null, T(e.response.options, (y, C) => (a(), n("label", {
      ...
      ]))), 128))])) : e.response.kind === "match" ? (a(), n("div", xe, [(a(!0), n(M, null, T(e.response.left, (y) => (a(), n("label", { key: y.id }, [U(u(y.text) + " ", 1), K(t("select", { "onUpdate:modelValue": (C) => v.value.values[y.id] = C }, [k[1] || (k[1] = t("option", { value: "" }, "选择对应项", -1)), (a(!0), n(M, null, T(e.response.right, (C) => (a(), n("option", {
        key: C.id,
        value: C.id
        ...
        checked: v.value.picked.includes(y.id),
        onChange: (C) => d(y.id)
      }, null, 40, Se), t("span", null, u(y.text), 1)], 2))), 128)), e.paragraphs.length ? b("", !0) : (a(), n("p", Me, "请先展开相关文稿，再选择原文依据。"))])) : e.response.kind === "gaps" ? (a(), n("div", Le, [(a(!0), n(M, null, T(e.response.slots, (y) => (a(), n("label", { key: y.id }, [U(u(y.text), 1), K(t("input", {
...
}), Ue = qe, Be = ["stroke-width"], De = ["d"], Ne = /* @__PURE__ */ F({
  __name: "LearningIcon",
  props: { name: {} },
  setup(e) {
    const l = {
...
}), q = Ne, He = { class: "learning-material" }, je = { class: "learning-source" }, Oe = { key: 0 }, Ke = ["href"], Ze = {
  key: 0,
  ...
  "aria-label": "材料朗读分段"
}, We = ["disabled", "onClick"], Ye = { key: 2 }, Ge = /* @__PURE__ */ F({
  ...
  setup(e, { emit: l }) {
    ...
    return (p, $) => (a(), n("article", He, [
      ...
      }, "看文稿", 8, ze)])) : (a(), n("div", Fe, [(a(!0), n(M, null, T(e.material.paragraphs, (g) => (a(), n("div", {
        key: g.id,
      ...
      e.material.parts.length ? (a(), n("small", Ye, "TTS 合成朗读")) : b("", !0)
    ]));
  }
}), le = Ge;
function ue(e, l, m = []) {
...
var Qe = { class: "learning-feedback" }, Xe = { class: "learning-muted" }, _e = { key: 0 }, et = { key: 1 }, tt = { key: 0 }, at = { key: 1 }, nt = { key: 2 }, lt = ["disabled"], it = ["disabled"], st = /* @__PURE__ */ F({
  ...
  key: 2,
  class: "learning-row"
}, dt = ["aria-label", "disabled"], vt = ["max", "value"], ct = /* @__PURE__ */ F({
...
var bt = ["onKeydown"], gt = {
  ...
  key: 1,
  class: "learning-margin-note"
}, Tt = { key: 0 }, Vt = { key: 1 }, Rt = { key: 2 }, qt = ["disabled"], Ut = /* @__PURE__ */ F({
  ...
  setup(e, { emit: l }) {
    ...
    B(() => m.target, async (h, x) => {
      x && v.value && d.set(`${x.kind}:${x.id}`, v.value.scrollTop), $.value = !1, g.value = null, await Y(), h && (p.value?.focus(), v.value && (v.value.scrollTop = d.get(`${h.kind}:${h.id}`) ?? 0));
    }), B(() => m.state.unit?.id, () => {
      y.value = {}, C = null;
    ...
    return (h, x) => e.target ? (a(), n("div", {
      ...
      onKeydown: G(z(k, ["stop", "prevent"]), ["esc"])
    }, [t("section", gt, [
      t("header", mt, [
...
`)), 1)) : b("", !0), f.value.solution.kind !== "semantic" ? (a(), n("p", Rt, u(f.value.solution.explanation), 1)) : (a(), n("button", {
  ...
  "aria-pressed",
  "onClick"
], Ot = { "aria-hidden": "true" }, Kt = ["disabled"], Zt = { class: "learning-teacher-options" }, zt = [
  "disabled",
  "aria-pressed",
  "onClick"
], Ft = { class: "learning-person-initial" }, Pt = {
  key: 0,
  class: "learning-selected-teacher"
}, Et = { class: "learning-person-initial" }, Jt = ["open"], Wt = ["disabled"], Yt = ["disabled"], Gt = { class: "learning-setup-actions" }, Qt = ["disabled"], Xt = ["disabled"], _t = /* @__PURE__ */ F({
  ...
  setup(e, { emit: l }) {
    ...
    async function $(g) {
      r.value = g, await Y(), v.value?.focus();
    }
    return X(() => r.value ? ($(0), !0) : !1), (g, c) => (a(), n("section", Dt, [t("div", Nt, [t("h1", {
      ...
      disabled: e.disabled,
      onClick: c[0] || (c[0] = (k) => $(1))
    }, [c[5] || (c[5] = U("继续", -1)), V(q, { name: "arrow" })], 8, Kt)], 64)) : (a(), n(M, { key: 1 }, [
      t("div", Zt, [(a(!0), n(M, null, T(e.state.candidates, (k) => (a(), n("button", {
        key: k.name,
        type: "button",
        disabled: e.disabled,
      ...
      }, [c[7] || (c[7] = U("和老师聊聊", -1)), V(q, { name: "arrow" })], 8, Xt)])
    ], 64))]));
  }
  ...
  key: 1,
  class: "learning-row"
}, ca = ["disabled"], ba = { class: "learning-muted" }, ga = ["disabled"], ma = /* @__PURE__ */ F({
  ...
  setup(e, { expose: l, emit: m }) {
    ...
    async function R() {
      await Y(), c && $.value && ($.value.scrollTop = $.value.scrollHeight);
    }
    function P() {
      const A = p.value;
...
${g.value.selection.quote}` : C;
    ...
    return l({
      ...
      e.state.teacher ? (a(), n("form", {
        ...
        "aria-label": "和老师说",
        placeholder: "和老师说…",
        onKeydown: [G(z(D, ["ctrl", "prevent"]), ["enter"]), G(z(D, ["meta", "prevent"]), ["enter"])]
...
var Ka = {
  class: "learning-app",
  "aria-label": "语伴语言学习"
}, Za = { class: "learning-toolbar" }, za = { "aria-label": "学习资料与设置" }, Fa = { "aria-label": "学习资料与设置" }, Pa = ["onClick"], Ea = {
  key: 0,
  class: "learning-notice",
  role: "status",
  "aria-live": "polite"
}, Ja = { class: "learning-row" }, Wa = ["disabled"], Ya = ["disabled"], Ga = ["disabled"], Qa = ["disabled"], Xa = {
  key: 0,
  class: "learning-working",
  role: "status"
}, _a = ["disabled"], en = {
  ...
  key: 0,
  class: "learning-muted"
}, Sn = ["value", "disabled"], Mn = ["disabled"], Ln = ["disabled"], Tn = ["disabled"], Vn = ["disabled"], Rn = ["disabled"], qn = ["disabled"], Un = ["disabled"], Bn = {
  role: "alertdialog",
  "aria-labelledby": "learning-confirm-title",
  class: "learning-confirm"
}, Dn = { class: "learning-row" }, Nn = ["disabled"], Hn = /* @__PURE__ */ F({
  __name: "LearningApp",
  props: {
    bridge: {},
    initialState: {}
  ...
  setup(e) {
    ...
    B(() => !!l.value.record, async (S, i) => {
      p.value !== "records" || S === i || (S && (j = C.value?.scrollTop ?? 0), await Y(), p.value === "records" && C.value && (C.value.scrollTop = S ? 0 : j));
    });
    ...
    async function H(S, i = !1) {
      ...
      if (C.value && (f[p.value] = C.value.scrollTop), g.value && (g.value.open = !1), p.value = S, await Y(), C.value) {
    ...
    return (S, i) => (a(), n("section", Ka, [
      t("header", Za, [
        ...
        t("details", {
          ...
          onKeydown: i[3] || (i[3] = G(z((o) => g.value.open = !1, ["stop", "prevent"]), ["esc"]))
        }, [t("summary", za, [V(q, { name: "more" })]), t("nav", Fa, [(a(), n(M, null, T([
          ["materials", "课件与笔记"],
          ["records", "学习记录"],
          ["goals", "学习目标"],
          ["harvest", "我的收获"],
        ...
        p.value === "settings" ? (a(), n("section", xn, [
          ...
          t("section", null, [
            ...
            s(l).voices.enabled ? (a(), n("form", {
              ...
              t("label", null, [i[39] || (i[39] = U("音色", -1)), K(t("select", { "onUpdate:modelValue": i[18] || (i[18] = (o) => D.value = o) }, [(a(!0), n(M, null, T(s(l).voices.voices, (o) => (a(), n("option", {
                key: o.id,
                value: o.id,
      ...
      R.value ? (a(), n("div", {
        ...
        onKeydown: i[30] || (i[30] = G(z((o) => R.value = null, ["stop", "prevent"]), ["esc"]))
      }, [t("section", Bn, [
