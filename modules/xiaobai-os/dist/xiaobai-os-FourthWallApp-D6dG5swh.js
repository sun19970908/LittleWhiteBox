/* eslint-disable */
import { C as Be, E as He, G as ce, H as Q, J as ee, K as G, S as ze, V as ke, Y as Re, c as ne, gt as V, h as te, ht as Xe, j as Fe, k as I, l as K, m as we, mt as ye, o as re, p as x, r as le, s as v, u as H, v as ge, z as se } from "./xiaobai-os-runtime-core.esm-bundler-x_Eikhco.js";
import { i as ie, l as Qe, o as ae } from "./xiaobai-os-runtime-dom.esm-bundler-DWFjb9Vy.js";
import { n as De, r as Oe } from "./xiaobai-os-app-navigation-BcQEoInO.js";
import { t as qe } from "./xiaobai-os-AppDialog-BtiJ8z-w.js";
...
var Je = Object.create, Ne = Object.defineProperty, Ye = Object.getOwnPropertyDescriptor, xe = Object.getOwnPropertyNames, er = Object.getPrototypeOf, rr = Object.prototype.hasOwnProperty, ar = (u, d) => () => (d || (u((d = { exports: {} }).exports, d), u = null), d.exports), tr = (u, d, l, f) => {
  ...
  (function() {
    ...
    function y(e, a) {
      ...
      for (var i = 0; i < e.length; ++i) {
        ...
        if (s.listeners) {
          ...
          for (var z in s.listeners) if (s.listeners.hasOwnProperty(z) && typeof s.listeners[z] != "function")
            return n.valid = !1, n.error = c + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + z + " must be a function but " + typeof s.listeners[z] + " given", n;
        }
        if (s.filter) {
    ...
    t.helper.escapeCharactersCallback = M, t.helper.escapeCharacters = function(e, a, r) {
      "use strict";
      var n = "([" + a.replace(/([\[\]\\])/g, "\\$1") + "])";
      r && (n = "\\\\" + n);
      var i = new RegExp(n, "g");
      return e = e.replace(i, M), e;
    ...
    var B = function(e, a, r, n) {
      "use strict";
      var i = n || "", c = i.indexOf("g") > -1, s = new RegExp(a + "|" + r, "g" + i.replace(/g/g, "")), m = new RegExp(a, i.replace(/g/g, "")), z = [], P, S, C, o, b;
      do
    ...
    t.helper.matchRecursiveRegExp = function(e, a, r, n) {
      ...
      var s = B(e, r, n, i), m = e, z = s.length;
      if (z > 0) {
        var P = [];
        s[0].wholeMatch.start !== 0 && P.push(e.slice(0, s[0].wholeMatch.start));
        for (var S = 0; S < z; ++S)
          P.push(a(e.slice(s[S].wholeMatch.start, s[S].wholeMatch.end), e.slice(s[S].match.start, s[S].match.end), e.slice(s[S].left.start, s[S].left.end), e.slice(s[S].right.start, s[S].right.end))), S < z - 1 && P.push(e.slice(s[S].wholeMatch.end, s[S + 1].wholeMatch.start));
        s[z - 1].wholeMatch.end < e.length && P.push(e.slice(s[z - 1].wholeMatch.end)), m = P.join("");
      }
      return m;
      ...
      function m() {
        ...
        a.extensions && t.helper.forEach(a.extensions, z);
      }
      function z(o, b) {
...
`).join(" "), J.nodeValue = J.nodeValue.replace(/(\s)+/g, "$1")) : J.nodeType === 1 && w(J);
      ...
      return e = e.replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, n), e = e.replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, n), e = e.replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, n), e = e.replace(/\[([^\[\]]+)]()()()()()/g, n), a.ghMentions && (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function(i, c, s, m, z) {
        if (s === "\\") return c + m;
        if (!t.helper.isString(a.ghMentionsLink)) throw new Error("ghMentionsLink option must be a string");
        var P = a.ghMentionsLink.replace(/\{u}/g, z), S = "";
    ...
    var F = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi, U = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+?)([.!?,()\[\]])?(\1)?(?=\s|$)(?!["<>])/gi, W = /()<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)()>()/gi, O = /(^|\s)(?:mailto:)?([A-Za-z0-9!#$%&'*+-/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?=$|\s)/gim, $ = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi, R = function(e) {
      ...
      return function(a, r, n, i, c, s, m) {
        ...
        var z = n, P = "", S = "", C = r || "", o = m || "";
        return /^www\./i.test(n) && (n = n.replace(/^www\./i, "http://www.")), e.excludeTrailingPunctuationFromURLs && s && (P = s), e.openLinksInNewWindow && (S = ' rel="noopener noreferrer" target="¨E95Eblank"'), C + '<a href="' + n + '"' + S + ">" + z + "</a>" + P + o;
      };
    }, D = function(e, a) {
      "use strict";
...
`;
        ...
        case "language":
        case "lang":
          m = ' lang="' + r.metadata.parsed[P] + '"', z += '<meta name="' + P + '" content="' + r.metadata.parsed[P] + `">
`;
          break;
        default:
          z += '<meta name="' + P + '" content="' + r.metadata.parsed[P] + `">
`;
      }
      return e = i + "<html" + m + `>
<head>
...
`, e = r.converter._dispatch("hashBlock.after", e, a, r), e;
      ...
      var n = function(i, c, s, m) {
        var z = s + t.subParser("encodeCode")(c, a, r) + m;
        return "¨C" + (r.gHtmlSpans.push(z) - 1) + "C";
      };
...
`;
      ...
      for (var c = 0; c < n.length; ++c)
        for (var s, m = new RegExp("^ {0,3}(<" + n[c] + "\\b[^>]*>)", "im"), z = "<" + n[c] + "\\b[^>]*>", P = "</" + n[c] + ">"; (s = t.helper.regexIndexOf(e, m)) !== -1; ) {
          var S = t.helper.splitAtIndex(e, s), C = t.helper.replaceRecursiveRegExp(S[1], i, z, P, "im");
          if (C === S[1]) break;
          e = S[0].concat(C);
        }
...
`;
      ...
      return e = e.replace(s, P), e = e.replace(c, z), e = e.replace(i, P), e = e.replace(n, P), e = e.replace(m, P), e = r.converter._dispatch("images.after", e, a, r), e;
...
`), s += "¨0";
        var z = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm, P = /\n[ \t]*\n(?!¨0)/.test(s);
        return a.disableForced4SpacesIndentedSublists && (z = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm), s = s.replace(z, function(S, C, o, b, j, T, N) {
          N = N && N.trim() !== "";
...
`;
      ...
      return e = r.converter._dispatch("lists.before", e, a, r), e += "¨0", r.gListLevel ? e = e.replace(/^(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(¨0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function(s, m, z) {
        return c(m, z.search(/[*+-]/g) > -1 ? "ul" : "ol", !0);
      }) : e = e.replace(/(\n\n|^\n?)(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(¨0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function(s, m, z, P) {
        return c(z, P.search(/[*+-]/g) > -1 ? "ul" : "ol", !1);
      ...
      for (c = i.length, s = 0; s < c; s++) {
        for (var z = "", P = i[s], S = !1; /¨(K|G)(\d+)\1/.test(P); ) {
          var C = RegExp.$1, o = RegExp.$2;
          C === "K" ? z = r.gHtmlBlocks[o] : S ? z = t.subParser("encodeCode")(r.ghCodeBlocks[o].text, a, r) : z = r.ghCodeBlocks[o].codeblock, z = z.replace(/\$/g, "$$$$"), P = P.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, z), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(P) && (S = !0);
        }
        i[s] = P;
      }
      return e = i.join(`
...
`), e = r.converter._dispatch("spanGamut.after", e, a, r), e;
      ...
      e += "¨0";
      var c = function(s, m, z, P, S, C, o) {
        return m = m.toLowerCase(), e.toLowerCase().split(m).length - 1 < 2 ? s : (z.match(/^data:.+?\/.+?;base64,/) ? r.gUrls[m] = z.replace(/\s/g, "") : r.gUrls[m] = t.subParser("encodeAmpsAndAngles")(z, a, r), C ? C + o : (o && (r.gTitles[m] = o.replace(/"|'/g, "&quot;")), a.parseImgDimensions && P && S && (r.gDimensions[m] = {
          width: P,
          height: S
        }), ""));
      };
...
` + a.preList[n] + "\n```";
      ...
      for (var i = e.childNodes, c = i.length, s = e.getAttribute("start") || 1, m = 0; m < c; ++m)
        if (!(typeof i[m].tagName > "u" || i[m].tagName.toLowerCase() !== "li")) {
          var z = "";
          r === "ol" ? z = s.toString() + ". " : z = "- ", n += z + t.subParser("makeMarkdown.listItem")(i[m], a), ++s;
        }
      return n += `
<!-- -->
`, n.trim();
...
`;
      ...
      for (s = 0; s < i.length; ++s) {
        var z = t.subParser("makeMarkdown.tableCell")(i[s], a), P = "---";
...
function zr(u = "", d = 0, l = [], f = []) {
  const t = String(u || ""), g = d + t.length, h = l.filter((M) => M.start < g && M.end > d), _ = [];
  let p = d;
  h.forEach((M) => {
    M.start > p && _.push([p, Math.min(M.start, g)]), p = Math.max(p, M.end);
  }), p < g && _.push([p, g]);
  let k = null, y = !1;
  for (const [M, B] of _) {
    const F = t.slice(Math.max(0, M - d), Math.max(0, B - d)).search(/\S/);
    if (F < 0) continue;
    y = !0;
    const U = Pr(f, M + F);
  ...
  return !y || !k?.size ? null : f.filter((M) => k.has(M.id)).sort((M, B) => B.depth - M.depth)[0] || null;
}
function Mr(u = []) {
...
`)), f = Ge(l);
  ...
  const t = Ke(d), g = d.map((h, _) => oe(h) ? null : zr(h, t[_], l, f));
...
`)), l = Ge(d);
  ...
  l.forEach((h) => {
    const _ = Me(f, h.openingTag.start), p = Me(f, h.closingTag.start);
  ...
  return u.forEach((h, _) => {
    ...
    M && g.push(h.slice(0, M));
    const U = F === h.length ? h.length : F, W = h.slice(M, U);
...
function Nr(u = "", d = {}) {
  ...
  let h = "", _ = 0, p = null;
  for (; (p = g.exec(l)) !== null; ) {
    const k = p[1] || "", y = p.index + k.length, M = g.lastIndex, B = String(p[3] || "").trim().split(/\s+/)[0] || "", F = String(p[4] || ""), U = Hr(B) || !B && Fr(F);
    h += t ? Ae(l.slice(_, y)) : l.slice(_, y), U && f !== "code" ? h += Dr(F, B || "html") : h += l.slice(y, M), _ = M;
  }
...
function Ze(u, d = globalThis.document) {
  const l = [], f = `XB4W${Array.from(crypto.getRandomValues(new Uint32Array(4))).join("")}MEDIA`, t = u.replace(/\[(?:img|图片)\s*:\s*([^\]]+)\]|\[(?:voice|语音)\s*:([^:\]]*):([^\]]+)\]|\[(?:voice|语音)\s*:\s*([^\]]+)\]/gi, (y, M, B, F, U, W) => {
    let O = 0;
    for (let $ = W - 1; $ >= 0 && u[$] === "\\"; $--) O++;
    return O % 2 ? y : (l.push(M !== void 0 ? {
      kind: "image",
      raw: y,
      value: M.trim()
    } : {
  ...
  }), g = new RegExp(`${f}(\\d+)END`, "g"), h = (y) => y.replace(g, (M, B) => l[Number(B)].raw);
  function _(y, M) {
    if (M) return [{
      kind: "text",
      value: h(y)
  ...
  function p(y, M = !1) {
    if (y.nodeType === 3) return _(y.textContent || "", M);
    ...
    const U = Array.from(B.childNodes).flatMap((O) => p(O, M || [
      "code",
      "pre",
      "a"
    ].includes(F)));
...
var na = ["data-message-index"], sa = ["src"], ia = {
  ...
  setup(u, { emit: d }) {
    ...
    const M = re(() => Ze(l.message.content)), B = re(() => l.message.ts ? new Intl.DateTimeFormat("zh-CN", {
      hour: "2-digit",
      minute: "2-digit"
    }).format(l.message.ts) : "");
    function F(a, r) {
    ...
    return He(() => {
      y = l.bridge.subscribe((a) => {
        ...
        for (const r of a) {
          ...
          const n = Number(r.target.dataset.imageIndex), i = M.value.media[n];
  ...
  setup(u, { emit: d }) {
    ...
    return se(() => l.page, ($) => {
      ...
      p.value && (await ze(), t.value && (t.value.scrollTop = t.value.scrollHeight));
    }), ($, R) => (I(), H("section", {
      ref_key: "viewport",
      ref: t,
      ...
      g.value.total === 0 && u.generation.status === "idle" ? (I(), H("div", za, [...R[6] || (R[6] = [
        v("span", null, "IV", -1),
        v("strong", null, "越过故事边界", -1),
        v("p", null, "这里是你与角色扮演者的皮下私聊。", -1)
      ])])) : K("", !0),
      (I(!0), H(le, null, Fe(g.value.messages, (D, q) => (I(), ne(Ca, {
      ...
      u.generation.status !== "idle" && p.value ? (I(), H("article", $a, [u.characterAvatar ? (I(), H("img", {
        ...
        key: 0,
        content: h.value
      }, null, 8, ["content"])) : (I(), H(le, { key: 1 }, [x(V(u.generation.status === "error" ? u.generation.message : M[u.generation.phase || "replying"]), 1)], 64)), u.generation.unsaved ? (I(), H("small", Ia, "未保存")) : K("", !0)])])])) : K("", !0),
  ...
  setup(u, { emit: d }) {
    ...
    return (h, _) => (I(), H("section", Na, [_[3] || (_[3] = v("h3", null, "聊天记录", -1)), v("div", Ua, [
      ...
      }, [(I(!0), H(le, null, Fe(u.sessions, (p) => (I(), H("option", {
        key: p.id,
        value: p.id
  ...
  setup(u, { emit: d }) {
    ...
    return (k, y) => (I(), H("aside", {
      ...
      type: "button",
      onClick: y[0] || (y[0] = (M) => f("close"))
    }, "关闭")]), v("div", Ja, [
      we(Qa, {
        sessions: u.chat.sessions,
        "active-session-id": u.chat.activeSessionId,
        disabled: u.busy,
        onSwitch: y[1] || (y[1] = (M) => f("switchSession", M)),
        onAdd: y[2] || (y[2] = (M) => f("addSession", M)),
        onRename: y[3] || (y[3] = (M, B) => f("renameSession", M, B)),
        onDelete: y[4] || (y[4] = (M) => f("deleteSession", M))
      }, null, 8, [
        "sessions",
        "active-session-id",
        "disabled"
      ...
      v("section", Ya, [
        ...
        v("label", null, [y[14] || (y[14] = x("带入的主聊天楼层数", -1)), Q(v("input", {
          "onUpdate:modelValue": y[5] || (y[5] = (M) => t.maxChatLayers = M),
          type: "number",
          min: "1",
          max: "9999"
        }, null, 512), [[
        ...
        v("label", xa, [y[15] || (y[15] = v("span", null, "流式生成", -1)), Q(v("input", {
          "onUpdate:modelValue": y[6] || (y[6] = (M) => t.stream = M),
          type: "checkbox"
        }, null, 512), [[ie, t.stream]])]),
        v("label", et, [y[16] || (y[16] = v("span", null, "禁用助手预填充", -1)), Q(v("input", {
          "onUpdate:modelValue": y[7] || (y[7] = (M) => t.disableAssistantPrefill = M),
          type: "checkbox"
      ...
      v("section", lt, [v("button", {
        type: "button",
        onClick: y[12] || (y[12] = (M) => f("openPrompts"))
      }, "提示词模板")])
    ])], 512));
  }
  ...
  class: "fourth-wall-dialog-error",
  role: "alert"
}, Pt = ["disabled"], zt = ["disabled"], ue = 35e3, Mt = /* @__PURE__ */ te({
  ...
  setup(u) {
    const d = u, l = G(structuredClone(ee(d.initialState))), f = G(""), t = G(!1), g = G(!1), h = G(!1), _ = G(""), p = G(!1), k = G(!1), y = G(!1), M = G(!1), B = G(""), F = G(0), U = G(!1), W = G(0);
    let O;
    const $ = G({
      status: "idle",
      sessionId: "",
    ...
    se(() => [f.value, $.value.text], () => {
      ...
      M.value = !1, k.value = !1, U.value = !1, f.value = "", $.value = {
        status: "idle",
        sessionId: "",
        text: "",
        thinking: "",
...
` : "";
    ...
    async function j() {
      ...
      try {
        ...
        B.value = L.result.content, F.value = w, M.value = !0;
      } catch (L) {
