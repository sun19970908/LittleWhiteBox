/* eslint-disable */
import { E as R, H as j, J as M, K as k, L as D, M as r, P as E, Q as y, T, X as q, Y as t, Z as F, _ as U, b as P, c as H, f as h, g as s, h as I, k as Q, l as X, p as a, q as K, s as Y, u as W, v as Z, y as V } from "./xiaobai-os-runtime-dom.esm-bundler-BcM9c-Z9.js";
import { n as G } from "./xiaobai-os-app-navigation-sg-40eOk.js";
var ee = { class: "world-article" }, te = { tabindex: "-1" }, ae = {
  ...
  props: { overview: {} },
  setup(d) {
    const e = k(!1), u = D(), i = `url("https://picsum.photos/800/300?random=${Math.random()}")`;
    return (n, o) => (r(), s("div", ie, [a("div", {
      class: "world-horizon",
      "aria-hidden": "true",
      style: F({ "--world-cover-image": i })
...
var we = { class: "world-toolbar" }, fe = { class: "world-tools" }, be = ["disabled", "title"], ye = ["onKeydown"], me = { class: "world-menu-sheet" }, ge = ["disabled"], _e = ["checked", "disabled"], ke = ["disabled"], he = ["disabled"], Se = ["disabled"], xe = {
  ...
  setup(d) {
    const { state: e, pending: u, writable: i, refreshing: n, notice: o, error: m, request: f } = pe(d), v = K(null), S = k(null), x = k(null), c = k(null), N = k(null);
    let A = 0, b = "";
    ...
    return G(() => c.value?.open ? (O(), !0) : v.value ? ($(), !0) : !1), (p, l) => (r(), s("section", {
      class: "world-app",
      "aria-label": "世界新闻",
      onPointerdown: z
    }, [
      a("header", we, [v.value ? (r(), s("button", {
        ...
        ref: c,
        class: "world-menu",
        onKeydown: H(X(O, ["stop", "prevent"]), ["esc"]),
        onFocusout: J
      ...
      j(a("div", {
        ...
        onClick: (Me) => _(w)
      }, [a("span", $e, [a("h2", null, y(w.title), 1), a("span", Ie, y(w.summary), 1)])], 8, Ce)]))), 128))])) : (r(), s("section", Ne, [
