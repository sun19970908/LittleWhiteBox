/* eslint-disable */
import { S as l, y as f, z as v } from "./xiaobai-os-runtime-core.esm-bundler-x_Eikhco.js";
...
function E(e, o) {
  ...
  y(() => (o(), !0), () => !!e.value), v(e, async (n, c, u) => {
    ...
    }), await l(), !(!n.isConnected || t && t.layers.value.at(-1) !== n) && m(n);
  }, { flush: "post" });
}
export {
  y as n,
