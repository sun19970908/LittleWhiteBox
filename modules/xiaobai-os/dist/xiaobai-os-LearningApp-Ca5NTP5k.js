/* eslint-disable */
import { C as ae, E as se, H as K, J as be, K as L, M as a, P as T, Q as u, R as ge, T as Q, X as _, Y as s, a as ee, b as z, c as X, f as O, g as n, h as b, k as re, l as P, m as Z, o as Y, p as t, q as me, s as ne, u as S, v as U, y as V, z as B } from "./xiaobai-os-runtime-dom.esm-bundler-BcM9c-Z9.js";
import { n as G, r as oe } from "./xiaobai-os-app-navigation-sg-40eOk.js";
var ye = ["disabled"], ke = {
  key: 0,
  ...
  setup(e, { emit: l }) {
    ...
    return (c, k) => (a(), n("form", {
      ...
      e.response.kind === "choice" ? (a(), n("div", ke, [(a(!0), n(S, null, T(e.response.options, (y, C) => (a(), n("label", {
      ...
      ]))), 128))])) : e.response.kind === "match" ? (a(), n("div", xe, [(a(!0), n(S, null, T(e.response.left, (y) => (a(), n("label", { key: y.id }, [U(u(y.text) + " ", 1), K(t("select", { "onUpdate:modelValue": (C) => v.value.values[y.id] = C }, [k[1] || (k[1] = t("option", { value: "" }, "选择对应项", -1)), (a(!0), n(S, null, T(e.response.right, (C) => (a(), n("option", {
        key: C.id,
        value: C.id
      }, u(C.text), 9, Ie))), 128))], 8, we), [[ee, v.value.values[y.id]]])]))), 128))])) : e.response.kind === "evidence" ? (a(), n("div", Ae, [(a(!0), n(S, null, T(e.paragraphs, (y) => (a(), n("label", {
        key: y.id,
        class: _({ selected: v.value.picked.includes(y.id) })
      }, [t("input", {
        type: "checkbox",
        checked: v.value.picked.includes(y.id),
        onChange: (C) => d(y.id)
      }, null, 40, Me), t("span", null, u(y.text), 1)], 2))), 128)), e.paragraphs.length ? b("", !0) : (a(), n("p", Se, "请先展开相关文稿，再选择原文依据。"))])) : e.response.kind === "gaps" ? (a(), n("div", Le, [(a(!0), n(S, null, T(e.response.slots, (y) => (a(), n("label", { key: y.id }, [U(u(y.text), 1), K(t("input", {
        "onUpdate:modelValue": (C) => v.value.values[y.id] = C,
        type: "text",
        maxlength: "4000",
        autocomplete: "off"
      }, null, 8, Te), [[Y, v.value.values[y.id]]])]))), 128))])) : (a(), n("label", Ve, [k[2] || (k[2] = t("span", { class: "learning-sr-only" }, "你的回答", -1)), K(t("textarea", {
        "onUpdate:modelValue": k[0] || (k[0] = (y) => v.value.text = y),
        rows: "6",
        maxlength: "4000",
        placeholder: "写下你的回答…"
      }, null, 512), [[Y, v.value.text]])])),
      t("button", {
...
}), Ue = qe, Be = ["stroke-width"], De = ["d"], Ne = /* @__PURE__ */ z({
  __name: "LearningIcon",
  props: { name: {} },
  setup(e) {
    const l = {
...
}), q = Ne, He = { class: "learning-material" }, je = { class: "learning-source" }, Oe = { key: 0 }, Ke = ["href"], Pe = {
  key: 0,
  class: "learning-listening-cover"
}, Ze = ["disabled"], ze = {
  key: 1,
  class: "learning-material-body"
}, Fe = ["onMouseup", "onKeyup"], Ee = ["disabled", "onClick"], Je = {
  class: "learning-audio-parts",
  "aria-label": "材料朗读分段"
}, We = ["disabled", "onClick"], Qe = { key: 2 }, Xe = /* @__PURE__ */ z({
  ...
  setup(e, { emit: l }) {
    ...
    return (p, $) => (a(), n("article", He, [
      ...
      e.material.hidden ? (a(), n("div", Pe, [$[1] || ($[1] = t("svg", {
        viewBox: "0 0 140 60",
        "aria-hidden": "true"
      }, [t("path", {
      ...
      }, "看文稿", 8, Ze)])) : (a(), n("div", ze, [(a(!0), n(S, null, T(e.material.paragraphs, (g) => (a(), n("div", {
        key: g.id,
        ...
        onMouseup: (c) => d(c, g),
        onKeyup: (c) => d(c, g)
      }, u(g.text), 41, Fe), t("button", {
        type: "button",
        disabled: e.disabled || [...g.text].length > 2e3,
        "aria-label": "选这段提问",
        onClick: (c) => v(g)
      }, "选段", 8, Ee)]))), 128))])),
      t("div", Je, [(a(!0), n(S, null, T(e.material.parts, (g) => (a(), n("button", {
        key: g.key,
        type: "button",
        disabled: e.disabled,
      ...
      }, [V(q, { name: "play" }), U(u(e.material.parts.length > 1 ? `听第 ${g.number} 段` : "播放朗读"), 1)], 8, We))), 128))]),
      e.material.parts.length ? (a(), n("small", Qe, "TTS 合成朗读")) : b("", !0)
    ]));
  }
}), le = Xe;
function ue(e, l, m = []) {
...
var Ye = { class: "learning-feedback" }, Ge = { class: "learning-muted" }, _e = { key: 0 }, et = { key: 1 }, tt = { key: 0 }, at = { key: 1 }, nt = { key: 2 }, lt = ["disabled"], it = ["disabled"], st = /* @__PURE__ */ z({
  ...
  setup(e) {
    ...
    return (m, r) => (a(), n("section", Ye, [
      ...
      e.feedback ? (a(), n(S, { key: 0 }, [
        ...
        e.feedback.understanding ? (a(), n("p", tt, [r[2] || (r[2] = t("b", null, "理解", -1)), U(u(e.feedback.understanding), 1)])) : b("", !0),
        e.feedback.expression ? (a(), n("p", at, [r[3] || (r[3] = t("b", null, "表达", -1)), U(u(e.feedback.expression), 1)])) : b("", !0),
        e.feedback.guidance ? (a(), n("p", nt, [r[4] || (r[4] = t("b", null, "批注", -1)), U(u(e.feedback.guidance), 1)])) : b("", !0),
        t("button", {
          type: "button",
          disabled: e.disabled,
...
var bt = ["onKeydown"], gt = {
  ...
  key: 1,
  class: "learning-margin-note"
}, Tt = { key: 0 }, Vt = { key: 1 }, Rt = { key: 2 }, qt = ["disabled"], Ut = /* @__PURE__ */ z({
  ...
  setup(e, { emit: l }) {
    ...
    B(() => m.target, async (h, x) => {
      x && v.value && d.set(`${x.kind}:${x.id}`, v.value.scrollTop), $.value = !1, g.value = null, await Q(), h && (p.value?.focus(), v.value && (v.value.scrollTop = d.get(`${h.kind}:${h.id}`) ?? 0));
    }), B(() => m.state.unit?.id, () => {
      y.value = {}, C = null;
    ...
    return (h, x) => e.target ? (a(), n("div", {
      ...
      onKeydown: X(P(k, ["stop", "prevent"]), ["esc"])
    }, [t("section", gt, [
      t("header", mt, [
        ...
        }, [x[17] || (x[17] = U("收起", -1)), V(q, { name: "back" })], 512)
      ]),
      ...
      t("div", {
        ...
        f.value && j.value.length ? (a(), n("details", pt, [t("summary", null, "阅读材料 · " + u(j.value.length), 1), (a(!0), n(S, null, T(j.value, (I) => (a(), Z(le, {
          key: I.id,
          material: I,
          "exercise-id": R.value,
          disabled: e.disabled,
          ...
          "exercise-id",
          "disabled"
        ]))), 128))])) : f.value ? b("", !0) : (a(!0), n(S, { key: 1 }, T(j.value, (I) => (a(), Z(le, {
          key: I.id,
          material: I,
          "exercise-id": R.value,
          disabled: e.disabled,
        ...
        f.value ? (a(), n("section", xt, [
          ...
          f.value.solution ? (a(), n("div", Lt, [f.value.solution.kind === "exact" ? (a(), n("p", Tt, u(s(ue)(f.value.solution.answer, f.value.response, F.value)), 1)) : f.value.solution.kind === "gaps" ? (a(), n("p", Vt, u(f.value.solution.accepted.map((I) => I.forms.join(" / ")).join(`
`)), 1)) : b("", !0), f.value.solution.kind !== "semantic" ? (a(), n("p", Rt, u(f.value.solution.explanation), 1)) : (a(), n("button", {
          ...
          (!D.value || $.value) && y.value[f.value.id] ? (a(), Z(Ue, {
            key: f.value.id,
            modelValue: A.value,
...
}), Bt = Ut, Dt = { class: "learning-profile-page" }, Nt = { class: "learning-setup-heading" }, Ht = { class: "learning-language-options" }, jt = [
  "disabled",
  "aria-pressed",
  "onClick"
], Ot = { "aria-hidden": "true" }, Kt = ["disabled"], Pt = { class: "learning-teacher-options" }, Zt = [
  "disabled",
  "aria-pressed",
  "onClick"
...
}, Et = { class: "learning-person-initial" }, Jt = ["open"], Wt = ["disabled"], Qt = ["disabled"], Xt = { class: "learning-setup-actions" }, Yt = ["disabled"], Gt = ["disabled"], _t = /* @__PURE__ */ z({
  ...
  setup(e, { emit: l }) {
    ...
    async function $(g) {
      r.value = g, await Q(), v.value?.focus();
    }
    return G(() => r.value ? ($(0), !0) : !1), (g, c) => (a(), n("section", Dt, [t("div", Nt, [t("h1", {
      ref_key: "heading",
      ref: v,
      tabindex: "-1"
      ...
      disabled: e.disabled,
      onClick: c[0] || (c[0] = (k) => $(1))
    }, [c[5] || (c[5] = U("继续", -1)), V(q, { name: "arrow" })], 8, Kt)], 64)) : (a(), n(S, { key: 1 }, [
      t("div", Pt, [(a(!0), n(S, null, T(e.state.candidates, (k) => (a(), n("button", {
        key: k.name,
        type: "button",
        disabled: e.disabled,
        ...
        e.state.teacher?.name === k.name ? (a(), Z(q, {
          key: 0,
          name: "check"
        })) : b("", !0)
      ], 8, Zt))), 128))]),
      e.state.teacher && !e.state.candidates.some((k) => k.name === e.state.teacher?.name) ? (a(), n("p", Ft, [
      ...
      t("details", {
        ...
        class: "learning-row",
        onSubmit: c[2] || (c[2] = P((k) => m("action", "teacher", { teacher: {
          name: d.value.trim(),
          note: ""
        } }), ["prevent"]))
      }, [K(t("input", {
      ...
      }, [c[7] || (c[7] = U("和老师聊聊", -1)), V(q, { name: "arrow" })], 8, Gt)])
    ], 64))]));
  }
  ...
  setup(e, { emit: l }) {
    const m = e, r = l;
    G(() => m.state.record ? (r("action", "records", { offset: m.state.records.offset }), !0) : !1);
    const v = {
      unassessed: "尚待练习",
      review: "待复核",
      independent: "已能独立使用",
    ...
    return (d, p) => (a(), n("section", ta, [t("div", aa, [p[5] || (p[5] = t("h1", null, "学习记录", -1)), e.state.records.total ? (a(), n("span", na, u(e.state.records.total) + " 项", 1)) : b("", !0)]), e.state.record ? (a(), n(S, { key: 0 }, [
      ...
      }, [t("span", null, [t("strong", null, u($.label), 1), t("small", null, [U(u($.evidenceCount) + " 份作答依据", 1), $.nextReviewAt ? (a(), n("span", da, " · 建议 " + u(new Date($.nextReviewAt).toLocaleDateString()) + " 再练", 1)) : b("", !0)])]), t("em", null, u(v[$.state]), 1)], 8, ua))), 128)),
...
}, Va = ["disabled"], Ra = { key: 2 }, qa = { class: "learning-composer-surface" }, Ua = {
  key: 0,
  ...
  setup(e, { expose: l, emit: m }) {
    ...
    async function R() {
      await Q(), c && $.value && ($.value.scrollTop = $.value.scrollHeight);
    }
    function F() {
      const A = p.value;
      A?.clientWidth && (A.style.height = "auto", A.style.height = `${A.scrollHeight}px`, R());
    }
    B(d, F, { flush: "post" }), B(p, (A) => {
      if (k?.disconnect(), cancelAnimationFrame(y), !A) return;
      let w = 0;
      k = new ResizeObserver(([h]) => {
        h.contentRect.width !== w && (w = h.contentRect.width, cancelAnimationFrame(y), y = requestAnimationFrame(F));
...
${g.value.selection.quote}` : C;
    ...
    return l({
      ...
      t("div", {
        ...
        (a(!0), n(S, null, T(e.state.conversation.turns, (h, x) => (a(), n("div", {
          ...
          h.presentation ? (a(), n("button", {
            ...
            V(q, { name: h.presentation.kind === "material" ? "book" : "records" }, null, 8, ["name"]),
          ...
          }, [V(q, { name: "sound" }), w[8] || (w[8] = U("听老师说", -1))], 8, Aa)) : b("", !0), e.state.reply.exerciseId && [...h.teacher].length <= 4e3 ? (a(), n("button", {
            key: 1,
            type: "button",
      ...
      e.state.teacher ? (a(), n("form", {
        ...
        onSubmit: P(D, ["prevent"])
      }, [t("div", qa, [g.value ? (a(), n("div", Ua, [t("span", null, u(g.value.selection?.quote ?? "请教这道题"), 1), t("button", {
        type: "button",
        "aria-label": "取消引用",
        ...
        "aria-label": "和老师说",
        placeholder: "和老师说…",
        onKeydown: [X(P(D, ["ctrl", "prevent"]), ["enter"]), X(P(D, ["meta", "prevent"]), ["enter"])]
      }, null, 40, Da), [[Y, d.value]]), t("button", {
        ...
        onClick: w[7] || (w[7] = P((h) => e.state.busy ? v("action", "cancel") : D(), ["prevent"]))
      }, [V(q, { name: e.state.busy ? "stop" : "send" }, null, 8, ["name"])], 10, Na)])])], 32)) : b("", !0)
    ]));
  }
}), ja = Ha;
function Oa(e) {
...
var Ka = {
  class: "learning-app",
  "aria-label": "语伴语言学习"
}, Pa = { class: "learning-toolbar" }, Za = { "aria-label": "学习资料与设置" }, za = { "aria-label": "学习资料与设置" }, Fa = ["onClick"], Ea = {
  key: 0,
  class: "learning-notice",
  role: "status",
  "aria-live": "polite"
}, Ja = { class: "learning-row" }, Wa = ["disabled"], Qa = ["disabled"], Xa = ["disabled"], Ya = ["disabled"], Ga = {
  key: 0,
  class: "learning-working",
  role: "status"
}, _a = ["disabled"], en = {
  ...
  key: 0,
  class: "learning-muted"
}, Mn = ["value", "disabled"], Sn = ["disabled"], Ln = ["disabled"], Tn = ["disabled"], Vn = ["disabled"], Rn = ["disabled"], qn = ["disabled"], Un = ["disabled"], Bn = {
  role: "alertdialog",
  ...
  setup(e) {
    ...
    G(() => g.value?.open ? (g.value.open = !1, !0) : !1, () => c.value);
    const k = L(null), y = L(null), C = L(null), f = {};
    let j = 0;
    B(() => !!l.value.record, async (M, i) => {
      p.value !== "records" || M === i || (M && (j = C.value?.scrollTop ?? 0), await Q(), p.value === "records" && C.value && (C.value.scrollTop = M ? 0 : j));
    });
    const R = L(null), F = L(null);
    oe(F, () => {
      R.value = null;
    });
    ...
    async function H(M, i = !1) {
      ...
      if (C.value && (f[p.value] = C.value.scrollTop), g.value && (g.value.open = !1), p.value = M, await Q(), C.value) {
    ...
    const te = G(() => g.value?.open ? (g.value.open = !1, !0) : p.value === "teacher" || !$.length && p.value === "profile" && !l.value.teacher ? !1 : (H($.pop() ?? "teacher", !0), !0));
    function J(M, i, o) {
      R.value = {
        action: M,
        input: i,
    ...
    return (M, i) => (a(), n("section", Ka, [
      t("header", Pa, [
        ...
        t("details", {
          ...
          onKeydown: i[3] || (i[3] = X(P((o) => g.value.open = !1, ["stop", "prevent"]), ["esc"]))
        }, [t("summary", Za, [V(q, { name: "more" })]), t("nav", za, [(a(), n(S, null, T([
          ["materials", "课件与笔记"],
          ["records", "学习记录"],
          ["goals", "学习目标"],
          ["harvest", "我的收获"],
        ...
        p.value === "settings" ? (a(), n("section", xn, [
          ...
          t("section", null, [
            ...
            s(l).voices.enabled ? (a(), n("form", {
              key: 1,
              onSubmit: i[21] || (i[21] = P((o) => s(d)("voice", { voice: {
                voiceId: D.value,
                language: E.value,
                speed: Number(A.value)
              } }), ["prevent"]))
            }, [
              t("label", null, [i[39] || (i[39] = U("音色", -1)), K(t("select", { "onUpdate:modelValue": i[18] || (i[18] = (o) => D.value = o) }, [(a(!0), n(S, null, T(s(l).voices.voices, (o) => (a(), n("option", {
                key: o.id,
                value: o.id,
                disabled: !o.available
              }, u(o.name) + u(o.available ? "" : "（暂不可用）"), 9, Mn))), 128))], 512), [[ee, D.value]])]),
              t("label", null, [i[40] || (i[40] = U("发音语言", -1)), K(t("input", {
      ...
      R.value ? (a(), n("div", {
        ...
        onKeydown: i[30] || (i[30] = X(P((o) => R.value = null, ["stop", "prevent"]), ["esc"]))
      }, [t("section", Bn, [
