/* eslint-disable */
import { E as ne, H as ee, I as ae, J as z, K as p, M as u, P as Q, Q as g, T as Y, X as te, Y as t, b as X, f as L, g as m, h as I, m as j, o as re, p as a, q as oe, s as se, u as H, v as le, z as x } from "./xiaobai-os-runtime-dom.esm-bundler-BcM9c-Z9.js";
import { n as ie } from "./xiaobai-os-app-navigation-sg-40eOk.js";
import { n as F, t as W } from "./xiaobai-os-room-catalog-CeHt_XVj.js";
function Z(s) {
...
function ue(s, y) {
  ...
  async function O() {
    return h || !C.value || f.value || e.value.status !== "ready" || e.value.generationActive ? !1 : q(structuredClone(z(C.value)));
  }
  ...
  async function V() {
    ...
    try {
      ...
      !h && o === k && r === e.value.chatIdentity && (R.value = P(l));
    } finally {
      o === k && (v.value = !1);
    }
  }
...
var de = { class: "game-lobby" }, ve = ["src"], ce = { class: "game-search" }, me = {
  ...
  emits: ["open"],
  setup(s) {
    const y = p(""), e = p("全部"), n = ["全部", ...new Set(W.map((b) => b.category))], i = L(() => W.filter((b) => (e.value === "全部" || b.category === e.value) && (b.name + b.tagline + b.category).includes(y.value.trim())));
    return (b, d) => (u(), m("section", de, [
      ...
      a("nav", me, [(u(), m(H, null, Q(n, (v) => a("button", {
        key: v,
        type: "button",
        "aria-pressed": e.value === v,
        onClick: (G) => e.value = v
      }, g(v), 9, fe)), 64))]),
      a("div", ye, [(u(!0), m(H, null, Q(i.value, (v) => (u(), m("button", {
        key: v.id,
        type: "button",
  ...
  setup(s) {
    ...
    return (e, n) => (u(), m("section", Ce, [
      ...
      s.records.length ? (u(), m("div", Ie, [(u(!0), m(H, null, Q(s.records, (i) => (u(), m("article", {
        key: i.id,
...
}), Le = De, Ee = { class: "game-app" }, Ue = { class: "game-header" }, qe = {
  class: "game-funds",
  "aria-label": "可用小白币"
}, ze = {
  class: "game-nav",
  "aria-label": "游戏页面"
}, Fe = ["aria-current"], Ne = ["aria-current"], Oe = ["aria-current"], Ve = {
  key: 0,
  class: "game-notice",
  role: "status"
  ...
  setup(s) {
    ...
    let B = 0;
    const f = p(n.value.activeGame ? "room" : "lobby"), $ = p(n.value.activeGame?.kind || null), U = oe(null), T = p(""), D = p(!1);
    let M = 0;
    const q = L(() => $.value ? F($.value) : null);
    async function N() {
      const r = q.value, l = ++M;
    ...
    x([
      ...
      l[0] === "lobby" && (B = E.value?.scrollTop || 0), Y(() => {
        E.value?.scrollTo({ top: f.value === "lobby" ? B : 0 });
      });
    }), x($, N, { immediate: !0 }), x(i, (r) => {
      r && ($.value = r.record.game);
    }), x(() => n.value.chatIdentity, () => {
      B = 0, $.value = n.value.activeGame?.kind || null, f.value = $.value ? "room" : "lobby", Y(() => {
    ...
    return ne(() => {
      ...
      a("nav", ze, [
        ...
        t(n).activeGame ? (u(), m("button", {
          ...
          onClick: V
        }, [...l[7] || (l[7] = [le(" 继续 ", -1), a("i", null, null, -1)])], 8, Ne)) : I("", !0),
        a("button", {
          type: "button",
